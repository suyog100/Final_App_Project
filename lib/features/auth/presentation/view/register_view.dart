...
class _RegisterViewState extends ConsumerState<RegisterView> {
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: size.height * 0.06),
                    _buildSocialButton(
                        'assets/images/google.png', 'Connect with Google'),
                    SizedBox(height: size.height * 0.02),
                    _buildSocialButton(
                        'assets/images/facebook.png', 'Connect with Facebook'),
                  ],
                ),
              ),
            ],
      ...
      child: ElevatedButton(
        onPressed: () async {
          if (_passwordController.text != _confirmPasswordController.text) {
            ...
            final result = await authViewModel.registerUser(
              AuthEntity(
                username: _usernameController.text,
                email: _emailController.text,
                password: _passwordController.text,
  ...
  Widget _buildDivider(Size size) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(height: 2, width: size.width * 0.2, color: Colors.black12),
        Text(
          "  Or continue with   ",
          style: TextStyle(
              fontWeight: FontWeight.bold, color: textColor2, fontSize: 16),
        ),
        Container(height: 2, width: size.width * 0.2, color: Colors.black12),
      ],
    );
